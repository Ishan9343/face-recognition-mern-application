...
const { euclideanDistance, manhattanDistance,getInitializationVector } = require("./utils")
...
app.post('/api/auth/register', cors(corsOptions), async (req, res) => {
    ...
    try {
        ...
        const user = await User.create({
            ...
            face_descriptor:descriptor.toString()
        })
...
app.post('/api/auth/login', cors(corsOptions), async (req, res) => {
    ...
    try {
        ...
        let bestMatchUser = {}
        users.forEach(u => {
            // Assuming stored descriptor is already encrypted
            
            const distance = euclideanDistance(descriptor.toString(), u.face_descriptor);
            console.log(u.face_descriptor)
            console.log(distance)
            // Compare input descriptor with stored descriptor
