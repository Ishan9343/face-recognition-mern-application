...
import { getCameraStatus, getScreenshot, setCameraStatus, setScreenshot, setIsFlashing, getActiveTab, setAuthError, getActiveSource, setActiveSource,getURL, setURL } from "../features/auth/authSlice"
...
export const PictureControls = () => {
    ...
    return(
        <>
        <h5 className="text-center"><strong>Capture Here</strong></h5>
        <div className="wrap-input100-image">
            ...
            </div>
            {
                ...
                <button
                    type="button"
                    className="btn btn-warning zoom-out"
